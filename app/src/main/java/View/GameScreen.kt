...
fun GameScreen(
    ...
    val pregunta = remember(random) { questionsViewModel.questions[random ?: 0].question }
                ...
                Column (modifier = Modifier.fillMaxWidth(0.9f)) {
                    Row(
                        ...
                        Button(
                            ...
                            Text(text = questionsViewModel.questions[random ?: 0].answers[0], textAlign = TextAlign.Center)
                        }
                        ...
                        Button(
                            ...
                            Text(text = questionsViewModel.questions[random ?: 0].answers[1], textAlign = TextAlign.Center)
                        }
                    }
                    ...
                    Row(
                        ...
                        Button(
                            ...
                            Text(text = questionsViewModel.questions[random ?: 0].answers[2], textAlign = TextAlign.Center)
                        }
                        Spacer(modifier = Modifier.fillMaxWidth(0.05f)) // Spacer for some space between buttons
                        Button(
                            onClick = { /*TODO*/ },
                            ...
                            Text(text = questionsViewModel.questions[random ?: 0].answers[3], textAlign = TextAlign.Center)
                        }
                    }
                }
            }
...
fun generarNumero(questionsViewModel: TriviaViewModel, preguntesFetes: MutableList<Int>): Int? {
    ...
    if (preguntesFetes.size == questionsViewModel.questions.size) {
        return null
    }
    val unusedIndices = (0 until questionsViewModel.questions.size).filterNot { it in preguntesFetes }
